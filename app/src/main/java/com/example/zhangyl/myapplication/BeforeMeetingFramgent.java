...
//                }
    ...
    public void onMeetingMgrEvent(MeetingListMgr.MeetingMgrEvent param){
        ...
        switch (param.event){
            case MeetingListMgr.MeetingMgrEvent.EVENT_START_DOWNLOAD_MEETING_LIST:
                onStartDownloadMeetingList();
                break;
            case MeetingListMgr.MeetingMgrEvent.EVENT_GET_MEETING_LIST_SUCC:
                onGetMeetingListSucc();
                break;
            case MeetingListMgr.MeetingMgrEvent.EVENT_GET_MEETING_LIST_FAILED:
