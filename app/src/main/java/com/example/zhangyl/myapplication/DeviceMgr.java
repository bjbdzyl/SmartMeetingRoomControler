...
public class DeviceMgr {
    ...
    List<MeetingDevice> device_list = new ArrayList<>();
    ...
    public interface DevListUpdateApi {
        ...
        Call<RegisterMgr.HttpResult> doUpdate(@Body DevListHttpBody body);
    }
    ...
    public void postDevList() {
        ...
        Call<RegisterMgr.HttpResult> resultCall = api.doUpdate(postBody); // todo 所有http接口统一集中到通信层
        ...
        resultCall.enqueue(new Callback<RegisterMgr.HttpResult>() {
            @Override
            public void onResponse(Call<RegisterMgr.HttpResult> call, Response<RegisterMgr.HttpResult> response) {
            ...
            @Override
            public void onFailure(Call<RegisterMgr.HttpResult> call, Throwable t) {
