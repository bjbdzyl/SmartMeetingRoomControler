...
public class ModeCfgListAdapter extends CommonAdapter<DevCtrlListViewItem>{

    private int nMode;

    public ModeCfgListAdapter(Context context, int layoutId, List<DevCtrlListViewItem> datas) {
