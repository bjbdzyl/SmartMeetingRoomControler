...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO 否则启动时，暂时空白。等待总管事件通知切换到哪个会议的哪一步界面。
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.init_fragments_container, InnerMeetingFragment.newInstance(null, null), InnerMeetingFragment.TAG).commit();
        ...
        mCurrentMeeting = MeetingListMgr.getInstance().getCurrentMeeting();
    ...
    private void onMeetingStart() {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.init_fragments_container, InnerMeetingFragment.newInstance(null, null), InnerMeetingFragment.TAG).commit();
    }
}
